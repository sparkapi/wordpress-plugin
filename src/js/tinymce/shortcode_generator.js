...
function ShortcodeGenerator(editor) {
  this.editor = editor;
...
// Returns and object.
ShortcodeGenerator.prototype.userValues = function() {
  var values = {};
...
ShortcodeGenerator.prototype.getInitialValues = function() {
  return $.extend( {}, this.defaultValues, this.userValues() );
};

ShortcodeGenerator.prototype.onsubmit = function( e ) {
...
ShortcodeGenerator.prototype.addPropertyTypeValues = function(){
  var self = this;
