...
class LeadGeneration extends \WP_Widget {
	...
	public static function flexmls_leadgen(){
		...
		if( array_key_exists( 'HomeStreetAddress', $data ) ){
			$body .= 'Current Address:' . PHP_EOL;
			$body .= $data[ 'HomeStreetAddress' ] . PHP_EOL;
			$body .= $data[ 'HomeLocality' ] . ', ' . $data[ 'HomeRegion' ] . ' ' . $data[ 'HomePostalCode' ] . PHP_EOL;
		}
		$body .= PHP_EOL;
	...
	public function form( $instance ){
		...
		<p>
			...
			<textarea class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'blurb' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'blurb' ) ); ?>" rows="2"><?php echo esc_textarea( $blurb ); ?></textarea>
			<small>This text appears below the title</small>
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'success' ) ); ?>">Success Message</label>
			<textarea class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'success' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'success' ) ); ?>" rows="2"><?php echo esc_textarea( $success ); ?></textarea>
