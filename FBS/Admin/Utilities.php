...
class Utilities {
	...
	public static function location_popup( $id = null ){
		$flexmls_settings = get_option( 'flexmls_settings' );
		//https://www.flexmls.com/cgi-bin/mainmenu.cgi?cmd=srv+api/search/getLocations.json&command_line_mode=true&callback=jQuery112406951562643334692_1493256784985&tech_id=x%2720071206231153226954000000%27&ma=x%2720070913202326493241000000%27&p=&l=8&q=&i=City,StateOrProvince,SteetAddress,PostalCode,CountyOrParish,SubdivisionName,MLSAreaMajor,ListingId,SchoolDistrict&std=Y&_=1493256784986
		?>
		<div id="<?php echo $id; ?>" title="Select a Location" class="flexmls-location-popup-thickbox" style="display: none;">
			<div class="flexmls-location-thickbox">
				<header>
					<input type="search" class="flexmls-searchbox" placeholder="Search by city, postal code, etc">
				</header>
				<section>
					Begin typing above to select a location
				</section>
			</div>
		</div>
		<?php
